...
module.exports = class extends BaseRest {
    ...
    async calculationAction () {
        ...
        if(serviceConfig.config_content){
            ...
            let totalPrice = parseFloat(exccedPrice) + parseFloat(distanceRule.start_price) + parseFloat(weightPrice);
