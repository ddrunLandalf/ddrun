<template>
  <div class="home-container">
    <div class="home-page-title">代理列表</div>
    ...
    <div class="flex flex-between item-center">
      <div class="flex flex-start item-cencer">
        <a-button type="primary" size="large" @click="$router.push('/user/agent/edit/add')"
          >添加代理</a-button
        >
      </div>
  ...
  data() {
    return {
      ...
      searchOptions: [
        ...
        { key: 'agentAccount', type: 'text', label: '账号', like: true },
      ...
      columns: [
        ...
        { title: '账号', key: 'agentAccount', scopedSlots: { customRender: 'agentAccount' } },
    ...
    actionClick(obj: { key: string; value: any }, text: any) {
      switch (obj.key) {
        case 'status':
          ...
          break;
        case 'update':
          this.$router.push({ path: '/user/agent/edit/update', query: text });
          break;
        case 'resetPwd':
