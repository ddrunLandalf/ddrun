  ...
  <div class="home-container">
    ...
    <div class="edit-content">
      <a-form-model ref="ruleForm" :model="formData" :rules="rules">
        <a-form-model-item ref="adminPwd" has-feedback label="登录密码" prop="adminPwd">
          <a-input
        ...
        <a-form-model-item ref="confirmPwd" has-feedback label="确认密码" prop="confirmPwd">
          <a-input
  ...
  data() {
    const validatePass = (_rule: any, value: string, callback: Function) => {
      if (value === '') {
        ...
        if ((this as any).formData.conformPwd !== '') {
