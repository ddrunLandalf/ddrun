<template>
  <div class="home-container">
    <div class="home-page-title">重量标签列表</div>
    ...
    <div class="flex flex-between item-center">
      <div class="flex flex-start item-cencer">
        <a-button type="primary" size="large" @click="$router.push('/city/weight/edit/add')"
          >添加重量标签</a-button
        >
      </div>
...
export default TableDataMixins.extend({
  data() {
    return {
      ...
      searchOptions: [{ key: 'tagName', type: 'text', label: '标签名称', like: true }],
      columns: [
        { title: '标签名称', key: 'tagName', dataIndex: 'tagName' },
